...
import unittest
import rostest
from apriltags_ros.msg import AprilTagsWithInfos, TagInfo, AprilTagDetectionArray
    ...
    def test_with_known_image(self):
        ...
        for tag in self.msg_tags.detections:
            if tag.id == 108:
                ...
                self.assertAlmostEqual(tag.pose.pose.position.z, 0.46, delta=0.1) # Allow 10 cm of error margin
